...
public class MulActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this,
                R.array.muliple_array, android.R.layout.simple_spinner_item);
    ...
    public void onItemSelected(AdapterView<?> adapterView, View view, int position, long l) {
        ...
        switch (position) {
            case 0:
                Integer first_0 = ThreadLocalRandom.current().nextInt(1,5);
                ...
                break;
            case 1:
                Integer first_1 = ThreadLocalRandom.current().nextInt(1,10);
        ...
        utility.generateSpeech(col1, col2, getApplicationContext(), " into ");
    }
